...
3. Get the Markdown code for the Codecov badge provided in `Settings > Badges` and update the `docs/index.md` of your repo with it so that the badge [![codecov](https://codecov.io/gh/AY2021S1-CS2103T-W12-4/tp/branch/master/graphs/badge.svg)](https://codecov.io/gh/AY2021S1-CS2103T-W12-4/tp) in that page reflects the coverage of your project.
...
1. Update the version number in [`MainApp.java`](https://github.com/AY2021S1-CS2103T-W12-4/tp/blob/master/src/main/java/team/serenity/MainApp.java).
