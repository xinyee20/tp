...
/**
 * Represents a storage for {@link seedu.address.model.Serenity}.
 */
public interface SerenityStorage {
    ...
    /**
     * Returns Serenity data as a {@link ReadOnlySerenity}. Returns {@code Optional.empty()} if storage file is not
     * found.
     *
