...
public class XlsxUtilTest {
    ...
    private Student AARON_TAN = new StudentBuilder().withName("AARON TAN").withId("A0123456U").build();
    private Student BU_WEN_JIN = new StudentBuilder().withName("BU WEN JIN").withId("A0123456M").build();
    private Student LAU_XIN_YEE = new StudentBuilder().withName("LAU XIN YEE").withId("A0765432U").build();
    private Student LIM_CHUN_YONG = new StudentBuilder().withName("LIM CHUN YONG").withId("A0388443R").build();
    private Student LIM_JIA_RUI_RYAN = new StudentBuilder().withName("LIM JIA RUI RYAN").withId("A0587314L").build();
    private Student NEO_RUI_EN_MAYBELLINE = new StudentBuilder().withName("NEO RUI EN MAYBELLINE").withId("A0139345U").build();

    private Set<Student> expectedStudents = new LinkedHashSet<>(){{
        add(AARON_TAN);
        add(BU_WEN_JIN);
        add(LAU_XIN_YEE);
        add(LIM_CHUN_YONG);
    ...
    private Set<StudentInfo> expectedStudentsInfo = new LinkedHashSet<>(){{
    ...
    private Set<Lesson> expectedLessons = new LinkedHashSet<>(){{
        UniqueList<StudentInfo> studentInfoList = new UniqueStudentInfoList();
        studentInfoList.setElementsWithList(new ArrayList<>(expectedStudentsInfo));
