...
public class AddGrpCommandParserTest {
    ...
    public void parse_validGroupNameAndFilePath_returnsAddGrpCommand() {
        AddGrpCommand expectedCommand = new AddGrpCommand(new Group(CommandTestUtil.VALID_GROUP_NAME_G04,
            CommandTestUtil.VALID_PATH_G04));
        String userInput = GRP_DESC_GROUP_G04 + PATH_DESC_GROUP_G04;
    ...
    public void parse_invalidGroupNameTooManyChars_throwsParseException() {
        ...
        String userInput = INVALID_GROUP_NAME_TOO_MANY_CHARS + " " + PREFIX_PATH + CommandTestUtil.VALID_PATH_G04;
    ...
    public void parse_invalidGroupNameTooLessChars_throwsParseException() {
        String expectedMessage = GroupName.MESSAGE_CONSTRAINTS;
        String userInput = INVALID_GROUP_NAME_TOO_LESS_CHARS + " " + PREFIX_PATH + CommandTestUtil.VALID_PATH_G04;
    ...
    public void parse_invalidGroupNameInvalidChars_throwsParseException() {
        String expectedMessage = GroupName.MESSAGE_CONSTRAINTS;
        String userInput = INVALID_GROUP_NAME_INVALID_CHARS + " " + PREFIX_PATH + CommandTestUtil.VALID_PATH_G04;
    ...
    public void parse_invalidGroupNameNonAlphabet_throwsParseException() {
        String expectedMessage = GroupName.MESSAGE_CONSTRAINTS;
        String userInput = INVALID_GROUP_NAME_NON_ALPHABET + " " + PREFIX_PATH + CommandTestUtil.VALID_PATH_G04;
    ...
    public void parse_invalidGroupNameNonDigits_throwsParseException() {
        String expectedMessage = GroupName.MESSAGE_CONSTRAINTS;
        String userInput = INVALID_GROUP_NAME_NON_DIGITS + " " + PREFIX_PATH + CommandTestUtil.VALID_PATH_G04;
    ...
    public void parse_invalidFilePathDash_throwsParseException() {
        String expectedMessage = GroupName.MESSAGE_CONSTRAINTS;
        String userInput = INVALID_GROUP_NAME_DASH + " " + PREFIX_PATH + CommandTestUtil.VALID_PATH_G04;
    ...
    public void parse_invalidGroupNameEmpty_throwsParseException() {
        ...
        String userInput = INVALID_GROUP_NAME_EMPTY + " " + PREFIX_PATH + CommandTestUtil.VALID_PATH_G04;
    ...
    public void parse_invalidGroupNameMultiple_throwsParseException() {
        ...
        String userInput = INVALID_GROUP_NAME_MULTIPLE + " " + PREFIX_PATH + CommandTestUtil.VALID_PATH_G04;
    ...
    public void parse_invalidFilePath_throwsParseException() {
        ...
        String userInput = GRP_DESC_GROUP_G04 + " " + PREFIX_PATH + INVALID_PATH;
    ...
    public void parse_invalidFilePathNonXlsx_throwsParseException() {
        ...
        String userInput = GRP_DESC_GROUP_G04 + " " + PREFIX_PATH + INVALID_PATH_NON_XLSX;
    ...
    public void parse_invalidFilePathEmpty_throwsParseException() {
        ...
        String userInput = GRP_DESC_GROUP_G04 + " " + PREFIX_PATH + INVALID_PATH_EMPTY;
